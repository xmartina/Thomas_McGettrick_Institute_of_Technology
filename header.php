            ...
            <div class="row">
                <div class="notification-entry col-12 text-center">
                    ...
                    <div class="notification_text">
                        <p>Free express shipping with orders over $150 </p>
                            ...
                            <div class="main-menu">
                                <nav>
                                    <ul>
                                        ...
                                        <li class="angle-shape drop_arrow"><a href="index.html">Home</a>
                                            <ul class="disturb_menu d-none">


                                                <li class="sub-menu-li"><a
                                                        href="index501f.html?preview_theme_id=122477707344">Home Demo
                                                        v1</a></li>


                                                <li class="sub-menu-li"><a
                                                        href="index2c6b.html?preview_theme_id=122478461008">Home Demo
                                                        v2</a></li>


                                                <li class="sub-menu-li"><a
                                                        href="index712d.html?preview_theme_id=122478493776">Home Demo
                                                        v3</a></li>


                                                <li class="sub-menu-li"><a
                                                        href="index3b70.html?preview_theme_id=122479902800">Home Demo
                                                        v4</a></li>
                                        ...
                                        <li class="angle-shape drop_arrow"><a href="collections/all.html">Shop</a>
                                            <ul class="disturb_menu d-none">
                                                ...
                                                <li class="sub-menu mega-menu-img sub-menu-li">
                                                    <a href="collections/best-sellers.html"><img
                                                            src="cdn/shop/collections/2d8ec.png?v=1698470765"
                                                ...
                                                <li class="sub-menu mega-menu-img sub-menu-li">
                                                    <a href="collections/most-viewed.html"><img
                                                            src="cdn/shop/collections/p880c1.png?v=1698470737"
                                                ...
                                                <li class="mega-menu-li"><a class="menu-title" href="collections.html">All
                                                        Collections</a>
                                                    <ul>
                                        ...
                                        <li class="angle-shape"><a href="blogs/news.html">Blog</a></li>


                                        <li class="angle-shape drop_arrow"><a href="#">Pages</a>
                                            <ul class="disturb_menu d-none">


                                                <li class="sub-menu-li"><a href="pages/authors-list.html">Author List
                                                        Page</a></li>
                                                ...
                                                <li class="sub-menu-li"><a href="pages/contact-us.html">Contact us</a>
                                                </li>


                                                <li class="sub-menu-li"><a href="pages/faq.html">Faq Page</a></li>


                                                <li class="sub-menu-li"><a href="404.html">404 Error Page</a></li>
                                        ...
                                        <li class="angle-shape"><a href="pages/about-us.html">About Us</a></li>


                                        <li class="angle-shape"><a href="pages/contact-us.html">Contact Us</a></li>
