...
<footer class="footer-area">
    <div id="shopify-section-footer_5" class="shopify-section">
                            ...
                            <div class="footer-widget mb-40">
                                ...
                                <div class="footer-list">
                                    <ul>
                                        ...
                                        <li><a href="index.html">Custom Link</a></li>
        ...
        <style data-shopify>#section-footer_5 {
                background: #282828 no-repeat scroll center center / cover;
                padding-top: 80px;
                padding-bottom: 0px;
                margin-top: 0px;
                margin-bottom: 0px;
    ...
    <div id="shopify-section-footer-bottom" class="shopify-section">
        <div class="footer-bottom " id="section-footer-bottom" style="border-top: 1px solid #313030;">
            <div class="container default ">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="payment-mathod pb-20 text-right"><a href="index.html">
                                <img src="cdn/shop/files/paymet_largefcce.png?v=1698813667" alt="">
                            </a></div>
                    </div>
                </div>
            </div>
        ...
        <style data-shopify>#section-footer-bottom {
                padding-top: 20px;
                padding-bottom: 0px;
                background: #242424 no-repeat scroll center center / cover;
            }
...
<!-- Necessary JS -->
<script src="cdn/shop/t/9/assets/fastclick.minbfc9.js?v=29723458539410922371698938058"></script>
<script src="cdn/shop/t/9/assets/timber9867.js?v=132601391146540697821698938089"></script>
            ...
            <div class="modal-body">
                <div class="modal-content-text">
                    ...
                    <div class="popup-content">
                        <p class="total_item"> There are <span class="cart_count bigcounter">0</span> Items In Your
                            Cart.</p>
                        <h3 class="productmsg"></h3>
                        <p class="success-message"><i class="sli sli-check"></i> Added to cart successfully!</p>
                        <div class="total_text_area">
                            <p class="cart_total"><span class="total_price_label">Total Price: </span> <span
                                    class="shopping-cart__total">£0.00</span></p>
                        </div>
                        <div class="modal-button">
                            <a href="cart.html" class="theme-default-button">View Cart</a>
                            <a href="account/login770e.html" class="theme-default-button">Checkout</a>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="qwick-view-right product-details-content quickview-content">
                            <div class="qwick-view-content">
                                ...
                                <form id="add-item-qv" action="https://dunki-demo.myshopify.com/cart/add"
                                      method="post">
...
<script src="cdn/shop/t/9/assets/wishlistc6e6.js?v=164725692185917909391698938060"></script>
<script>
    /* Ajax Wishlist */
...
<script src="cdn/shop/t/9/assets/jquery.currencies.min2502.js?v=35452912321688254271698938059"></script>
